...
public class DynamicEvents : ISystem
{
    ...
    private readonly TriggerBox triggerBox;
    private readonly BoxComponent triggerCollisionComponent;
    private readonly Actor leftActor;
    private readonly Actor rightActor;
    private readonly StaticMeshComponent leftStaticMeshComponent;
    private readonly StaticMeshComponent rightStaticMeshComponent;
    ...
    private readonly Action<Actor> OnTriggerOverlapActor = (actor) => Debug.AddOnScreenMessage((int)(actor.ID % int.MaxValue), 3.0f, Color.Aqua, "Trigger box overlapped " + actor.Name);

    private readonly Action<StaticMeshComponent> OnTriggerOverlapComponent = (component) => Debug.AddOnScreenMessage((int)(component.ID % int.MaxValue), 3.0f, Color.Aquamarine, "Trigger collision component overlapped " + component.Name);
