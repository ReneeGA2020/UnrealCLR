...
public class InstancedStaticMeshes : ISystem
{
    ...
    private readonly InstancedStaticMeshComponent instancedStaticMeshComponent;
    ...
    public void OnTick(float deltaTime)
    {
        ...
        _ = instancedStaticMeshComponent.BatchUpdateInstanceTransforms(0, transforms, markRenderStateDirty: true);
    }
