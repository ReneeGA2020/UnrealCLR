...
```
dotnet publish "../Framework" --configuration Release --framework net8.0
dotnet publish --configuration Release --framework net8.0 --output "%Project%/Managed/Tests"
```
